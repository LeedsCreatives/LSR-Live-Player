...
<html lang="en">
  ...
  <body>
    <div class="container-responsive" style="max-width: 1200px; margin-left: auto; margin-right: auto;">
      ...
      <div style="width:100%;padding:2%; background-color: #e74c3c; color: #ecf0f1; text-align: center; font-size: 1.2em;">We&apos;re currently experiencing some problems outside our control which is causing the stream not to be available. We&apos;ll be back ASAP - keep an eye on <a style="color: #f39c12"> href="http://twitter.com/thisislsr">@ThisIsLSR</a> for updates!</div>
  ...
  <div class="lsrplayer-section-ondemand">
    ...
    <div class="row">
      <div class="col-xs-6">
        <button type="button" id="nextbutton" onClick="changePage(prevurl, 'next')" class="btn btn-lsr btn-block"><i class="fa fa-arrow-left" aria-hidden="true"></i> Newer</button>
      </div>
      <div class="col-xs-6">
        <button type="button" id="prevbutton" onClick="changePage(nexturl, 'prev')" class="btn btn-lsr btn-block">Older <i class="fa fa-arrow-right" aria-hidden="true"></i></button>
      </div>
    </div>
  </div>
</div>
    ...
    $(document).ready(function(){
    	...
    	var stream = {
    		...
    		mp3: "http://109.123.114.172:6648/live;"
    	},
    	ready = false;
  ...
  if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {
    document.getElementById("control-row").innerHTML = '<div class="col-xs-12"><div class="jp-controls-holder"><div class="jp-controls"><button class="jp-play" id="button-play" onClick="setButton(\'button-play\', \'button-stop\')" role="button" tabindex="0"><img src="./assets/css/jplayer-theme/img/play.png" class="lsrplayer-jp-controls" /></button><button class="jp-stop" id="button-stop" style="display:none;" onClick="setButton(\'button-stop\', \'button-play\')" role="button" tabindex="0"><img src="./assets/css/jplayer-theme/img/stop.png" class="lsrplayer-jp-controls" /></button></div></div></div>';
  }
</script>
  </body>
</html>
